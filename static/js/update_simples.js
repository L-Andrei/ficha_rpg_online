$(function (){
    ...
    var log = JSON.stringify({id:personagem,dano_sofrido:dano_sofrido,dano_mental:dano_mental,cura:cura,san_regen:san_regen,pe_ganho:pe_ganho,pe_gasto:pe_gasto});
